...
- SignalR hub for live push updates (`TopicHub`) — reads/writes work, nothing pushes yet; MQTT ingestion is ready for it to push through once it exists
